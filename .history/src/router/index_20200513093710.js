    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {path: '/cgs', meta: {keepAlive: true, isBack: false}, component: () => import('../components/homePage/cgs'), name: 'cgs'},
                {path: '/sb', meta: {keepAlive: true, isBack: false}, component: () => import('../components/homePage/sb'), name: 'sb'},
